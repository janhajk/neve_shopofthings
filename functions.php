...
if ( ! function_exists( 'neve_shopofthings_enqueue_styles' ) ):
	/**
	 * Load CSS file.
	 */
      function neve_shopofthings_enqueue_styles() {
          wp_enqueue_style( 'neve-shopofthings', trailingslashit( get_stylesheet_directory_uri() ) . 'style.css', array( 'neve-style' ), NEVE_VERSION );
      }
endif;
add_action('wp_enqueue_scripts', 'neve_shopofthings_enqueue_styles', 20);
